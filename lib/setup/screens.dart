...
class GitHostSetupScreenState extends State<GitHostSetupScreen> {
  ...
  Widget _buildPage(BuildContext context, int pos) {
    ...
    if (pos == 3) {
      if (_setupPagesChoices[0] == AccountProviderChoice.CustomProvider) {
  ...
  void _launchDeployKeyPage() async {
    ...
    final gitHubUrl = NotiumUrls.notiumURLs['githubBaseURL'] + repoName + NotiumUrls.notiumURLs['newGithubKeySuffix'];
    final gitLabUrl = NotiumUrls.notiumURLs['gitlabBaseURL'] + repoName + NotiumUrls.notiumURLs['newGitlabKeySuffix'];
